...
{
    "location": "#",
    "page": "The DS9.jl package",
    "title": "The DS9.jl package",
    "category": "page",
    "text": ""
},

{
    "location": "#The-DS9.jl-package-1",
    "page": "The DS9.jl package",
    "title": "The DS9.jl package",
    "category": "section",
...
{
    "location": "requests/#DS9-requests-1",
    "page": "DS9 requests",
    "title": "DS9 requests",
    "category": "section",
    "text": "There are two kinds of requests: get requests to retrieve some information or data form SAOImage/DS9 and set requests to send some data to SAOImage/DS9 or to set some of its parameters."
},
...
{
    "location": "connect/#",
    "page": "Connection to a specific SAOImage/DS9 server",
    "title": "Connection to a specific SAOImage/DS9 server",
    "category": "page",
    "text": ""
},

{
    "location": "connect/#Connection-to-a-specific-SAOImage/DS9-server-1",
    "page": "Connection to a specific SAOImage/DS9 server",
    "title": "Connection to a specific SAOImage/DS9 server",
    "category": "section",
...

{
    "location": "library/#",
    "page": "DS9.jl library",
    "title": "DS9.jl library",
    "category": "page",
    "text": ""
},

{
    "location": "library/#DS9.jl-library-1",
    "page": "DS9.jl library",
    "title": "DS9.jl library",
    "category": "section",
    "text": ""
